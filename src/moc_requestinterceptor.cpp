...
QT_MOC_LITERAL(1, 19, 7), // "blocked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5) // "adUrl"

    },
    "RequestInterceptor\0blocked\0\0adUrl"
};
...
void RequestInterceptor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RequestInterceptor *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->blocked((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RequestInterceptor::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequestInterceptor::blocked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RequestInterceptor::blocked(QString _t1)
{
